...
foreach(COMP ${HAL_FIND_COMPONENTS_FAMILIES})
    ...
    if((NOT STM32_HAL_${FAMILY}_PATH) AND (NOT STM32_CUBE_${FAMILY}_PATH) AND (NOT ${STM32_LOCAL_HAL_LIB_PATH}))
    ...
    find_path(HAL_${FAMILY}_PATH
        ...
        PATHS "${STM32_HAL_${FAMILY}_PATH}" "${STM32_CUBE_${FAMILY}_PATH}/Drivers/STM32${FAMILY}xx_HAL_Driver" "${STM32_LOCAL_HAL_LIB_PATH}"
        NO_DEFAULT_PATH
    )
